...
**IAM administrator** – If you're an IAM administrator, you might want to learn details about how you can write policies to manage access to AWS SGW\. To view example AWS SGW identity\-based policies that you can use in IAM, see [AWS Storage Gateway identity\-based policy examples](security_iam_id-based-policy-examples.md)\.
