...
+ [Testing your FSx File gateway connection to gateway endpoints](#MaintenanceTestGatewayConnectivity-fgw)
...
![\[Image NOT FOUND\]](http://docs.aws.amazon.com/filegateway/latest/filefsxw/images/GatewayMaintenance_75.png)<a name="MaintenanceConsoleWindowMenu-fgw"></a>
...
![\[Image NOT FOUND\]](http://docs.aws.amazon.com/filegateway/latest/filefsxw/images/local-console-file-0.png)

1. On the **HTTP Proxy Configuration menu**, enter **1** and provide the host name for the HTTP proxy server\.  
![\[Image NOT FOUND\]](http://docs.aws.amazon.com/filegateway/latest/filefsxw/images/local-console-file-1.png)
...
![\[Image NOT FOUND\]](http://docs.aws.amazon.com/filegateway/latest/filefsxw/images/local-console-file-2.png)    
[\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/filegateway/latest/filefsxw/manage-on-premises-fgw.html)

## Testing your FSx File gateway connection to gateway endpoints<a name="MaintenanceTestGatewayConnectivity-fgw"></a>
...
![\[Image NOT FOUND\]](http://docs.aws.amazon.com/filegateway/latest/filefsxw/images/local-console-file-4.png)    
[\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/filegateway/latest/filefsxw/manage-on-premises-fgw.html)
...
![\[Image NOT FOUND\]](http://docs.aws.amazon.com/filegateway/latest/filefsxw/images/available-commands.png)
...
![\[Image NOT FOUND\]](http://docs.aws.amazon.com/filegateway/latest/filefsxw/images/VerifyAdapterType.png)
...
![\[Image NOT FOUND\]](http://docs.aws.amazon.com/filegateway/latest/filefsxw/images/ResetDHCP.png)

   If your gateway is already activated, you must shut it down and restart it from the Storage Gateway Management Console\. After the gateway restarts, you must test network connectivity to the internet\. For information about how to test network connectivity, see [Testing your FSx File gateway connection to gateway endpoints](#MaintenanceTestGatewayConnectivity-fgw)\.